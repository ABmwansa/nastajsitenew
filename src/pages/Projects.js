    ...
    current: [
      {
        ...
        description:
          'Ongoing construction of a state-of-the-art laboratory with high-grade materials, quality and commitment to specified standards.',
      },
      {
        id: 2,
        ...
        image: imagexi,
        description:
          ' Construction of Modern and state-of-the-art office buildings and apartments under construction. .',
      },
      {
        id: 1,
        title: 'Warma Laboratory',
    ...
    complete: [
      {
        ...
        startDate: 'Mar 2023',
        contact: 'mwansa.amosb@gmail.com 0979235167',
        image: '/assets/construction-bg.jpg.jpeg.png',
        description:
          'A completed university college project featuring lecture halls, administrative blocks, and recreational facilities.',
      },
    ],
    upcoming: [
      {
        ...
        description:
          'An eco-conscious green space with walking paths, open-air event zones, and solar-powered lighting.',
      },
    ],
  };
      ...
      .map((project) => (
        <tr key={project.id}>
          ...
          <td>
            ...
            <button className="show-more-btn" onClick={() => openModal(project)}>
              Show More
            </button>
          </td>
          <td>
  ...
  return (
    <div className="projects-wrapper">
      ...
      <div className="tab-buttons">
        <button onClick={() => handleTabClick('current')} className={activeTab === 'current' ? 'active' : ''}>
          Current Projects
        </button>
        <button onClick={() => handleTabClick('complete')} className={activeTab === 'complete' ? 'active' : ''}>
          Completed Projects
        </button>
        <button onClick={() => handleTabClick('upcoming')} className={activeTab === 'upcoming' ? 'active' : ''}>
          Upcoming Projects
        </button>
      </div>
...
{visibleRowCount < projects[activeTab].length && (
  <div style={{ textAlign: 'center', marginTop: '20px' }}>
    <button
      ...
      onClick={() => setVisibleRowCount(projects[activeTab].length)}
    >
      View More
    </button>
  </div>
