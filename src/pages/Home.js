    ...
    <div className="home">
      ...
      <section className="hero-section" style={{ backgroundImage: `url(${heroImage})` }}>
        <div className="hero-content">
          ...
          <p style={{color:'white', fontSize:'2rem'}}>Quality construction services tailored to your needs.</p>
      ...
      <section className="services-section">
        ...
        <div className="services-grid">
          <div className="service-card">
            ...
            <p>Roads, Bridges, and Drainage Infrastructure
✓ Buildings and Industrial Infrastructure,Warehousing
...
.</p>
          ...
          <div className="service-card">
            ...
            <p>Water Supply, and Sanitation Infrastructure
            </p>
            <button className="Learn-more">Learn More</button>
          </div>
          <div className="service-card">
            <img src={Consultancy} alt="Values" />
            <h3>Consultancy</h3>
            <p>Proving top Quality Professional Consultancy and Supervising.</p>
            <button className="Learn-more">Learn More</button>
          </div>
          <div className="service-card">
            <img src={Manufacturing} alt="Values" />
            <h3>Manufacturing</h3>
            <p>Proving top Quality Professional Consultancy and Supervising.</p>
            <button className="Learn-more">Learn More</button>
          </div>
      ...
      <div className="projects-grid">
        ...
        <div className="project-card">
          {/* <img src={valuesImage} alt="Project 3" /> */}
    ...
    <footer className="footer">
      <div className="footer-container">
        ...
        <div className="footer-center">
          ...
          <p>Visit Our Offices in <a href='https://www.google.com/maps/search/?api=1&query=15.4067,28.2871' target="_blank" rel="noopener noreferrer">Roma</a></p>
